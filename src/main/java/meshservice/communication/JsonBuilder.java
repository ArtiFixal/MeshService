...
public class JsonBuilder{
	...
	private<T> JsonBuilder setField(String fieldName,T value)
	{
        ...
        public<T> JsonBuilder addArray(String fieldName,T[] array) throws IllegalArgumentException
        {
            if(array.length==0)
        ...
        public JsonBuilder addArray(String fieldName,Collection coll) throws IllegalArgumentException
        {
            if(coll.isEmpty())
